...
class Command(BasicCommand):
    ...
    def handle(self, *args, **kwargs):
        self._heading('Elasticsearch mapping process starting')
    ...
    def gather_models(self, passed_models):
        ...
        for model in gathered:
            # getattr(model._meta, 'es_type', None) is not None and 
    ...
    def run_mappings(self):
        for module, name in self.models:
            ...
            self._write("Running mapping for {}".format(ModelClass.__name__))
            ModelClass.elastic.run_mapping()